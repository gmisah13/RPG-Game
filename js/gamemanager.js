let GameManager = {
  ...
  setFight: function() {
    ...
    let enemy00 = new Enemy("Baphomet", 100, 0, 50, 100, 100);
    let enemy01 = new Enemy("Darklord", 200, 0, 150, 80, 150);
    ...
    getEnemy.innerHTML = '<img src="img/avatar-enemies/' + enemy.enemyType.toLowerCase() + '.png" alt="' + enemy.enemyType + '"class="img-avatar"><div><h3>' + enemy.enemyType + '</h3><p class="health-enemy">Health: ' + enemy.health + '</p><p>Mana: ' + enemy.mana +
